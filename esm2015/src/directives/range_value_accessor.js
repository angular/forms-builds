...
RangeValueAccessor.ngDirectiveDef = i0.ɵdefineDirective({ type: RangeValueAccessor, selectors: [["input", "type", "range", "formControlName", ""], ["input", "type", "range", "formControl", ""], ["input", "type", "range", "ngModel", ""]], factory: function RangeValueAccessor_Factory(t) { return new (t || RangeValueAccessor)(i0.ɵdirectiveInject(Renderer2), i0.ɵinjectElementRef()); }, hostBindings: function RangeValueAccessor_HostBindings(dirIndex, elIndex) { i0.ɵL("change", function RangeValueAccessor_change_HostBindingHandler($event) { const pd_b = (i0.ɵd(dirIndex).onChange($event.target.value) !== false); return pd_b; }); i0.ɵL("input", function RangeValueAccessor_input_HostBindingHandler($event) { const pd_b = (i0.ɵd(dirIndex).onChange($event.target.value) !== false); return pd_b; }); i0.ɵL("blur", function RangeValueAccessor_blur_HostBindingHandler($event) { const pd_b = (i0.ɵd(dirIndex).onTouched() !== false); return pd_b; }); }, features: [i0.ɵPublicFeature] });
if (false) {
    /** @type {?} */
