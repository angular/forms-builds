...
/** @nocollapse */ NgControlStatus.ngDirectiveDef = i0.ΔdefineDirective({ type: NgControlStatus, selectors: [["", "formControlName", ""], ["", "ngModel", ""], ["", "formControl", ""]], factory: function NgControlStatus_Factory(t) { return new (t || NgControlStatus)(i0.ΔdirectiveInject(i1.NgControl, 2)); }, hostBindings: function NgControlStatus_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        i0.Δstyling(_c0);
    } if (rf & 2) {
...
/** @nocollapse */ NgControlStatusGroup.ngDirectiveDef = i0.ΔdefineDirective({ type: NgControlStatusGroup, selectors: [["", "formGroupName", ""], ["", "formArrayName", ""], ["", "ngModelGroup", ""], ["", "formGroup", ""], ["form", 3, "ngNoForm", ""], ["", "ngForm", ""]], factory: function NgControlStatusGroup_Factory(t) { return new (t || NgControlStatusGroup)(i0.ΔdirectiveInject(i2.ControlContainer, 2)); }, hostBindings: function NgControlStatusGroup_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        i0.Δstyling(_c0);
    } if (rf & 2) {
        i0.ΔclassProp(0, ctx.ngClassUntouched);
        i0.ΔclassProp(1, ctx.ngClassTouched);
