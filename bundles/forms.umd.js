...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var RangeValueAccessor = /** @class */ (function () {
        ...
        RangeValueAccessor.ngDirectiveDef = i0.ɵdefineDirective({ type: RangeValueAccessor, selectors: [["input", "type", "range", "formControlName", ""], ["input", "type", "range", "formControl", ""], ["input", "type", "range", "ngModel", ""]], factory: function RangeValueAccessor_Factory(t) { return new (t || RangeValueAccessor)(i0.ɵinjectRenderer2(), i0.ɵdirectiveInject(i0.ElementRef)); }, hostBindings: function RangeValueAccessor_HostBindings(dirIndex, elIndex) { i0.ɵlistener("change", function RangeValueAccessor_change_HostBindingHandler($event) { var pd_b = (i0.ɵloadDirective(dirIndex).onChange($event.target.value) !== false); return pd_b; }); i0.ɵlistener("input", function RangeValueAccessor_input_HostBindingHandler($event) { var pd_b = (i0.ɵloadDirective(dirIndex).onChange($event.target.value) !== false); return pd_b; }); i0.ɵlistener("blur", function RangeValueAccessor_blur_HostBindingHandler($event) { var pd_b = (i0.ɵloadDirective(dirIndex).onTouched() !== false); return pd_b; }); }, features: [i0.ɵPublicFeature] });
    ...
    */
     ...
     * found in the LICENSE file at https://angular.io/license
     */
    var VERSION = new i0.Version('7.0.0-beta.7+47.sha-7cf5807');
