...
export declare class NgForm extends ControlContainer implements Form, AfterViewInit {
    ...
    static ɵfac: i0.ɵɵFactoryDef<NgForm, [{ optional: true; self: true; }, { optional: true; self: true; }]>;
    static ɵdir: i0.ɵɵDirectiveDefWithMeta<NgForm, "form:not([ngNoForm]):not([formGroup]),ng-form,[ngForm]", ["ngForm"], { "options": "ngFormOptions"; }, { "ngSubmit": "ngSubmit"; }, never>;
}
