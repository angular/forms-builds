...
import { InjectionToken, ɵisObservable, ɵisPromise, Directive, ElementRef, Renderer2, forwardRef, Inject, Optional, Version, Self, Host, Input, SkipSelf, Injectable, NgModule, Injector, EventEmitter, Output, ɵlooseIdentical, isDevMode, ɵdefineDirective, ɵinjectRenderer2, ɵdirectiveInject, ɵlistener, ɵloadDirective, ɵPublicFeature, ɵelementProperty, ɵbind, ɵInheritDefinitionFeature, defineInjectable, ɵdefineNgModule, defineInjector, INJECTOR, ɵNgOnChangesFeature, ɵgetInheritedFactory } from '@angular/core';
...
DefaultValueAccessor.ngDirectiveDef = ɵdefineDirective({ type: DefaultValueAccessor, selectors: [["input", "formControlName", "", 3, "type", "checkbox"], ["textarea", "formControlName", ""], ["input", "formControl", "", 3, "type", "checkbox"], ["textarea", "formControl", ""], ["input", "ngModel", "", 3, "type", "checkbox"], ["textarea", "ngModel", ""], ["", "ngDefaultControl", ""]], factory: function DefaultValueAccessor_Factory(t) { return new (t || DefaultValueAccessor)(ɵinjectRenderer2(), ɵdirectiveInject(ElementRef), ɵdirectiveInject(COMPOSITION_BUFFER_MODE, 8)); }, hostBindings: function DefaultValueAccessor_HostBindings(dirIndex, elIndex) { ɵlistener("input", function DefaultValueAccessor_input_HostBindingHandler($event) { const pd_b = (ɵloadDirective(dirIndex)._handleInput($event.target.value) !== false); return pd_b; }); ɵlistener("blur", function DefaultValueAccessor_blur_HostBindingHandler($event) { const pd_b = (ɵloadDirective(dirIndex).onTouched() !== false); return pd_b; }); ɵlistener("compositionstart", function DefaultValueAccessor_compositionstart_HostBindingHandler($event) { const pd_b = (ɵloadDirective(dirIndex)._compositionStart() !== false); return pd_b; }); ɵlistener("compositionend", function DefaultValueAccessor_compositionend_HostBindingHandler($event) { const pd_b = (ɵloadDirective(dirIndex)._compositionEnd($event.target.value) !== false); return pd_b; }); }, features: [ɵPublicFeature] });
...
NumberValueAccessor.ngDirectiveDef = ɵdefineDirective({ type: NumberValueAccessor, selectors: [["input", "type", "number", "formControlName", ""], ["input", "type", "number", "formControl", ""], ["input", "type", "number", "ngModel", ""]], factory: function NumberValueAccessor_Factory(t) { return new (t || NumberValueAccessor)(ɵinjectRenderer2(), ɵdirectiveInject(ElementRef)); }, hostBindings: function NumberValueAccessor_HostBindings(dirIndex, elIndex) { ɵlistener("change", function NumberValueAccessor_change_HostBindingHandler($event) { const pd_b = (ɵloadDirective(dirIndex).onChange($event.target.value) !== false); return pd_b; }); ɵlistener("input", function NumberValueAccessor_input_HostBindingHandler($event) { const pd_b = (ɵloadDirective(dirIndex).onChange($event.target.value) !== false); return pd_b; }); ɵlistener("blur", function NumberValueAccessor_blur_HostBindingHandler($event) { const pd_b = (ɵloadDirective(dirIndex).onTouched() !== false); return pd_b; }); }, features: [ɵPublicFeature] });
...
RadioControlRegistry.ngInjectableDef = defineInjectable({ token: RadioControlRegistry, factory: function RadioControlRegistry_Factory(t) { return new (t || RadioControlRegistry)(); }, providedIn: null });
/**
 * \@description
 *
...
RadioControlValueAccessor.ngDirectiveDef = ɵdefineDirective({ type: RadioControlValueAccessor, selectors: [["input", "type", "radio", "formControlName", ""], ["input", "type", "radio", "formControl", ""], ["input", "type", "radio", "ngModel", ""]], factory: function RadioControlValueAccessor_Factory(t) { return new (t || RadioControlValueAccessor)(ɵinjectRenderer2(), ɵdirectiveInject(ElementRef), ɵdirectiveInject(RadioControlRegistry), ɵdirectiveInject(INJECTOR)); }, hostBindings: function RadioControlValueAccessor_HostBindings(dirIndex, elIndex) { ɵlistener("change", function RadioControlValueAccessor_change_HostBindingHandler($event) { const pd_b = (ɵloadDirective(dirIndex).onChange() !== false); return pd_b; }); ɵlistener("blur", function RadioControlValueAccessor_blur_HostBindingHandler($event) { const pd_b = (ɵloadDirective(dirIndex).onTouched() !== false); return pd_b; }); }, inputs: { name: "name", formControlName: "formControlName", value: "value" }, features: [ɵPublicFeature] });
...
RangeValueAccessor.ngDirectiveDef = ɵdefineDirective({ type: RangeValueAccessor, selectors: [["input", "type", "range", "formControlName", ""], ["input", "type", "range", "formControl", ""], ["input", "type", "range", "ngModel", ""]], factory: function RangeValueAccessor_Factory(t) { return new (t || RangeValueAccessor)(ɵinjectRenderer2(), ɵdirectiveInject(ElementRef)); }, hostBindings: function RangeValueAccessor_HostBindings(dirIndex, elIndex) { ɵlistener("change", function RangeValueAccessor_change_HostBindingHandler($event) { const pd_b = (ɵloadDirective(dirIndex).onChange($event.target.value) !== false); return pd_b; }); ɵlistener("input", function RangeValueAccessor_input_HostBindingHandler($event) { const pd_b = (ɵloadDirective(dirIndex).onChange($event.target.value) !== false); return pd_b; }); ɵlistener("blur", function RangeValueAccessor_blur_HostBindingHandler($event) { const pd_b = (ɵloadDirective(dirIndex).onTouched() !== false); return pd_b; }); }, features: [ɵPublicFeature] });
...
SelectControlValueAccessor.ngDirectiveDef = ɵdefineDirective({ type: SelectControlValueAccessor, selectors: [["select", "formControlName", "", 3, "multiple", ""], ["select", "formControl", "", 3, "multiple", ""], ["select", "ngModel", "", 3, "multiple", ""]], factory: function SelectControlValueAccessor_Factory(t) { return new (t || SelectControlValueAccessor)(ɵinjectRenderer2(), ɵdirectiveInject(ElementRef)); }, hostBindings: function SelectControlValueAccessor_HostBindings(dirIndex, elIndex) { ɵlistener("change", function SelectControlValueAccessor_change_HostBindingHandler($event) { const pd_b = (ɵloadDirective(dirIndex).onChange($event.target.value) !== false); return pd_b; }); ɵlistener("blur", function SelectControlValueAccessor_blur_HostBindingHandler($event) { const pd_b = (ɵloadDirective(dirIndex).onTouched() !== false); return pd_b; }); }, inputs: { compareWith: "compareWith" }, features: [ɵPublicFeature] });
/**
 * \@description
 *
...
NgSelectOption.ngDirectiveDef = ɵdefineDirective({ type: NgSelectOption, selectors: [["option"]], factory: function NgSelectOption_Factory(t) { return new (t || NgSelectOption)(ɵdirectiveInject(ElementRef), ɵinjectRenderer2(), ɵdirectiveInject(SelectControlValueAccessor, 9)); }, inputs: { ngValue: "ngValue", value: "value" }, features: [ɵPublicFeature] });
...
SelectMultipleControlValueAccessor.ngDirectiveDef = ɵdefineDirective({ type: SelectMultipleControlValueAccessor, selectors: [["select", "multiple", "", "formControlName", ""], ["select", "multiple", "", "formControl", ""], ["select", "multiple", "", "ngModel", ""]], factory: function SelectMultipleControlValueAccessor_Factory(t) { return new (t || SelectMultipleControlValueAccessor)(ɵinjectRenderer2(), ɵdirectiveInject(ElementRef)); }, hostBindings: function SelectMultipleControlValueAccessor_HostBindings(dirIndex, elIndex) { ɵlistener("change", function SelectMultipleControlValueAccessor_change_HostBindingHandler($event) { const pd_b = (ɵloadDirective(dirIndex).onChange($event.target) !== false); return pd_b; }); ɵlistener("blur", function SelectMultipleControlValueAccessor_blur_HostBindingHandler($event) { const pd_b = (ɵloadDirective(dirIndex).onTouched() !== false); return pd_b; }); }, inputs: { compareWith: "compareWith" }, features: [ɵPublicFeature] });
/**
 * Marks `<option>` as dynamic, so Angular can be notified when options change.
 *
 * \@usageNotes
...
NgSelectMultipleOption.ngDirectiveDef = ɵdefineDirective({ type: NgSelectMultipleOption, selectors: [["option"]], factory: function NgSelectMultipleOption_Factory(t) { return new (t || NgSelectMultipleOption)(ɵdirectiveInject(ElementRef), ɵinjectRenderer2(), ɵdirectiveInject(SelectMultipleControlValueAccessor, 9)); }, inputs: { ngValue: "ngValue", value: "value" }, features: [ɵPublicFeature] });
...
NgControlStatus.ngDirectiveDef = ɵdefineDirective({ type: NgControlStatus, selectors: [["", "formControlName", ""], ["", "ngModel", ""], ["", "formControl", ""]], factory: function NgControlStatus_Factory(t) { return new (t || NgControlStatus)(ɵdirectiveInject(NgControl, 2)); }, hostBindings: function NgControlStatus_HostBindings(dirIndex, elIndex) { ɵelementProperty(elIndex, "class.ng-untouched", ɵbind(ɵloadDirective(dirIndex).ngClassUntouched)); ɵelementProperty(elIndex, "class.ng-touched", ɵbind(ɵloadDirective(dirIndex).ngClassTouched)); ɵelementProperty(elIndex, "class.ng-pristine", ɵbind(ɵloadDirective(dirIndex).ngClassPristine)); ɵelementProperty(elIndex, "class.ng-dirty", ɵbind(ɵloadDirective(dirIndex).ngClassDirty)); ɵelementProperty(elIndex, "class.ng-valid", ɵbind(ɵloadDirective(dirIndex).ngClassValid)); ɵelementProperty(elIndex, "class.ng-invalid", ɵbind(ɵloadDirective(dirIndex).ngClassInvalid)); ɵelementProperty(elIndex, "class.ng-pending", ɵbind(ɵloadDirective(dirIndex).ngClassPending)); }, hostVars: 7, features: [ɵPublicFeature, ɵInheritDefinitionFeature] });
/**
...
NgForm.ngDirectiveDef = ɵdefineDirective({ type: NgForm, selectors: [["form", 3, "ngNoForm", "", 3, "formGroup", ""], ["ngForm"], ["ng-form"], ["", "ngForm", ""]], factory: function NgForm_Factory(t) { return new (t || NgForm)(ɵdirectiveInject(NG_VALIDATORS, 10), ɵdirectiveInject(NG_ASYNC_VALIDATORS, 10)); }, hostBindings: function NgForm_HostBindings(dirIndex, elIndex) { ɵlistener("submit", function NgForm_submit_HostBindingHandler($event) { const pd_b = (ɵloadDirective(dirIndex).onSubmit($event) !== false); return pd_b; }); ɵlistener("reset", function NgForm_reset_HostBindingHandler($event) { const pd_b = (ɵloadDirective(dirIndex).onReset() !== false); return pd_b; }); }, inputs: { options: "ngFormOptions" }, outputs: { ngSubmit: "ngSubmit" }, features: [ɵPublicFeature, ɵInheritDefinitionFeature], exportAs: "ngForm" });
...
NgFormSelectorWarning.ngDirectiveDef = ɵdefineDirective({ type: NgFormSelectorWarning, selectors: [["ngForm"]], factory: function NgFormSelectorWarning_Factory(t) { return new (t || NgFormSelectorWarning)(ɵdirectiveInject(NG_FORM_SELECTOR_WARNING, 8)); }, features: [ɵPublicFeature] });
...
NgModelGroup.ngDirectiveDef = ɵdefineDirective({ type: NgModelGroup, selectors: [["", "ngModelGroup", ""]], factory: function NgModelGroup_Factory(t) { return new (t || NgModelGroup)(ɵdirectiveInject(ControlContainer, 5), ɵdirectiveInject(NG_VALIDATORS, 10), ɵdirectiveInject(NG_ASYNC_VALIDATORS, 10)); }, inputs: { name: "ngModelGroup" }, features: [ɵPublicFeature, ɵInheritDefinitionFeature], exportAs: "ngModelGroup" });
...
NgModel.ngDirectiveDef = ɵdefineDirective({ type: NgModel, selectors: [["", "ngModel", "", 3, "formControlName", "", 3, "formControl", ""]], factory: function NgModel_Factory(t) { return new (t || NgModel)(ɵdirectiveInject(ControlContainer, 9), ɵdirectiveInject(NG_VALIDATORS, 10), ɵdirectiveInject(NG_ASYNC_VALIDATORS, 10), ɵdirectiveInject(NG_VALUE_ACCESSOR, 10)); }, inputs: { name: "name", isDisabled: "disabled", model: "ngModel", options: "ngModelOptions" }, outputs: { update: "ngModelChange" }, features: [ɵPublicFeature, ɵInheritDefinitionFeature, ɵNgOnChangesFeature], exportAs: "ngModel" });
...
FormGroupDirective.ngDirectiveDef = ɵdefineDirective({ type: FormGroupDirective, selectors: [["", "formGroup", ""]], factory: function FormGroupDirective_Factory(t) { return new (t || FormGroupDirective)(ɵdirectiveInject(NG_VALIDATORS, 10), ɵdirectiveInject(NG_ASYNC_VALIDATORS, 10)); }, hostBindings: function FormGroupDirective_HostBindings(dirIndex, elIndex) { ɵlistener("submit", function FormGroupDirective_submit_HostBindingHandler($event) { const pd_b = (ɵloadDirective(dirIndex).onSubmit($event) !== false); return pd_b; }); ɵlistener("reset", function FormGroupDirective_reset_HostBindingHandler($event) { const pd_b = (ɵloadDirective(dirIndex).onReset() !== false); return pd_b; }); }, inputs: { form: "formGroup" }, outputs: { ngSubmit: "ngSubmit" }, features: [ɵPublicFeature, ɵInheritDefinitionFeature, ɵNgOnChangesFeature], exportAs: "ngForm" });
...
FormGroupName.ngDirectiveDef = ɵdefineDirective({ type: FormGroupName, selectors: [["", "formGroupName", ""]], factory: function FormGroupName_Factory(t) { return new (t || FormGroupName)(ɵdirectiveInject(ControlContainer, 13), ɵdirectiveInject(NG_VALIDATORS, 10), ɵdirectiveInject(NG_ASYNC_VALIDATORS, 10)); }, inputs: { name: "formGroupName" }, features: [ɵPublicFeature, ɵInheritDefinitionFeature] });
/** @type {?} */
...
RequiredValidator.ngDirectiveDef = ɵdefineDirective({ type: RequiredValidator, selectors: [["", "required", "", "formControlName", "", 3, "type", "checkbox"], ["", "required", "", "formControl", "", 3, "type", "checkbox"], ["", "required", "", "ngModel", "", 3, "type", "checkbox"]], factory: function RequiredValidator_Factory(t) { return new (t || RequiredValidator)(); }, hostBindings: function RequiredValidator_HostBindings(dirIndex, elIndex) { ɵelementProperty(elIndex, "attr.required", ɵbind((ɵloadDirective(dirIndex).required ? "" : null))); }, hostVars: 1, inputs: { required: "required" }, features: [ɵPublicFeature] });
/**
...
CheckboxRequiredValidator.ngDirectiveDef = ɵdefineDirective({ type: CheckboxRequiredValidator, selectors: [["input", "type", "checkbox", "required", "", "formControlName", ""], ["input", "type", "checkbox", "required", "", "formControl", ""], ["input", "type", "checkbox", "required", "", "ngModel", ""]], factory: function CheckboxRequiredValidator_Factory(t) { return ɵCheckboxRequiredValidator_BaseFactory((t || CheckboxRequiredValidator)); }, hostBindings: function CheckboxRequiredValidator_HostBindings(dirIndex, elIndex) { ɵelementProperty(elIndex, "attr.required", ɵbind((ɵloadDirective(dirIndex).required ? "" : null))); }, hostVars: 1, features: [ɵPublicFeature, ɵInheritDefinitionFeature] });
...
EmailValidator.ngDirectiveDef = ɵdefineDirective({ type: EmailValidator, selectors: [["", "email", "", "formControlName", ""], ["", "email", "", "formControl", ""], ["", "email", "", "ngModel", ""]], factory: function EmailValidator_Factory(t) { return new (t || EmailValidator)(); }, inputs: { email: "email" }, features: [ɵPublicFeature] });
/** *
...
MinLengthValidator.ngDirectiveDef = ɵdefineDirective({ type: MinLengthValidator, selectors: [["", "minlength", "", "formControlName", ""], ["", "minlength", "", "formControl", ""], ["", "minlength", "", "ngModel", ""]], factory: function MinLengthValidator_Factory(t) { return new (t || MinLengthValidator)(); }, hostBindings: function MinLengthValidator_HostBindings(dirIndex, elIndex) { ɵelementProperty(elIndex, "attr.minlength", ɵbind((ɵloadDirective(dirIndex).minlength ? ɵloadDirective(dirIndex).minlength : null))); }, hostVars: 1, inputs: { minlength: "minlength" }, features: [ɵPublicFeature, ɵNgOnChangesFeature] });
/** *
...
MaxLengthValidator.ngDirectiveDef = ɵdefineDirective({ type: MaxLengthValidator, selectors: [["", "maxlength", "", "formControlName", ""], ["", "maxlength", "", "formControl", ""], ["", "maxlength", "", "ngModel", ""]], factory: function MaxLengthValidator_Factory(t) { return new (t || MaxLengthValidator)(); }, hostBindings: function MaxLengthValidator_HostBindings(dirIndex, elIndex) { ɵelementProperty(elIndex, "attr.maxlength", ɵbind((ɵloadDirective(dirIndex).maxlength ? ɵloadDirective(dirIndex).maxlength : null))); }, hostVars: 1, inputs: { maxlength: "maxlength" }, features: [ɵPublicFeature, ɵNgOnChangesFeature] });
/** @type {?} */
...
PatternValidator.ngDirectiveDef = ɵdefineDirective({ type: PatternValidator, selectors: [["", "pattern", "", "formControlName", ""], ["", "pattern", "", "formControl", ""], ["", "pattern", "", "ngModel", ""]], factory: function PatternValidator_Factory(t) { return new (t || PatternValidator)(); }, hostBindings: function PatternValidator_HostBindings(dirIndex, elIndex) { ɵelementProperty(elIndex, "attr.pattern", ɵbind((ɵloadDirective(dirIndex).pattern ? ɵloadDirective(dirIndex).pattern : null))); }, hostVars: 1, inputs: { pattern: "pattern" }, features: [ɵPublicFeature, ɵNgOnChangesFeature] });
...
FormBuilder.ngInjectableDef = defineInjectable({ token: FormBuilder, factory: function FormBuilder_Factory(t) { return new (t || FormBuilder)(); }, providedIn: null });
...
NgNoValidate.ngDirectiveDef = ɵdefineDirective({ type: NgNoValidate, selectors: [["form", 3, "ngNoForm", "", 3, "ngNativeValidate", ""]], factory: function NgNoValidate_Factory(t) { return new (t || NgNoValidate)(); }, attributes: ["novalidate", ""], features: [ɵPublicFeature] });
...
InternalFormsSharedModule.ngModuleDef = ɵdefineNgModule({ type: InternalFormsSharedModule, bootstrap: [], declarations: [NgNoValidate,
        NgSelectOption,
        NgSelectMultipleOption,
        DefaultValueAccessor,
        NumberValueAccessor,
        ...
        CheckboxRequiredValidator,
        EmailValidator] });
InternalFormsSharedModule.ngInjectorDef = defineInjector({ factory: function InternalFormsSharedModule_Factory(t) { return new (t || InternalFormsSharedModule)(); }, providers: [], imports: [SHARED_FORM_DIRECTIVES] });
...
ReactiveFormsModule.ngModuleDef = ɵdefineNgModule({ type: ReactiveFormsModule, bootstrap: [], declarations: [FormControlDirective, FormGroupDirective, FormControlName, FormGroupName, FormArrayName], imports: [], exports: [InternalFormsSharedModule, FormControlDirective, FormGroupDirective, FormControlName, FormGroupName, FormArrayName] });
ReactiveFormsModule.ngInjectorDef = defineInjector({ factory: function ReactiveFormsModule_Factory(t) { return new (t || ReactiveFormsModule)(); }, providers: [FormBuilder, RadioControlRegistry], imports: [[InternalFormsSharedModule, REACTIVE_DRIVEN_DIRECTIVES]] });
