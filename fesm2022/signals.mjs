...
class Field {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.0-next.0+sha-d7e5aea", ngImport: i0, type: Field, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "21.1.0-next.0+sha-d7e5aea", type: Field, isStandalone: true, selector: "[field]", inputs: { field: { classPropertyName: "field", publicName: "field", isSignal: true, isRequired: true, transformFunction: null } }, providers: [
            { provide: FIELD, useExisting: Field },
            { provide: NgControl, useFactory: () => inject(Field).ɵgetOrCreateNgControl() },
        ], ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.0-next.0+sha-d7e5aea", ngImport: i0, type: Field, decorators: [{
            type: Directive,
            args: [{
                    selector: '[field]',
                    providers: [
