...
import { InjectionToken, ɵisObservable, ɵisPromise, ElementRef, forwardRef, Version, ɵdefineDirective, ɵinjectRenderer2, ɵdirectiveInject, ɵlistener, ɵload, ɵPublicFeature, ɵInheritDefinitionFeature, ɵelementProperty, ɵbind, defineInjectable, EventEmitter, ɵNgOnChangesFeature, ɵdefineNgModule, defineInjector, ɵlooseIdentical, ɵgetInheritedFactory, INJECTOR, isDevMode } from '@angular/core';
...
var RangeValueAccessor = /** @class */ (function () {
    ...
    RangeValueAccessor.ngDirectiveDef = ɵdefineDirective({ type: RangeValueAccessor, selectors: [["input", "type", "range", "formControlName", ""], ["input", "type", "range", "formControl", ""], ["input", "type", "range", "ngModel", ""]], factory: function RangeValueAccessor_Factory(t) { return new (t || RangeValueAccessor)(ɵinjectRenderer2(), ɵdirectiveInject(ElementRef)); }, hostBindings: function RangeValueAccessor_HostBindings(dirIndex, elIndex) { ɵlistener("change", function RangeValueAccessor_change_HostBindingHandler($event) { var pd_b = (ɵload(dirIndex).onChange($event.target.value) !== false); return pd_b; }); ɵlistener("input", function RangeValueAccessor_input_HostBindingHandler($event) { var pd_b = (ɵload(dirIndex).onChange($event.target.value) !== false); return pd_b; }); ɵlistener("blur", function RangeValueAccessor_blur_HostBindingHandler($event) { var pd_b = (ɵload(dirIndex).onTouched() !== false); return pd_b; }); }, features: [ɵPublicFeature] });
